...
try {
    ...
    if (-not $DryRun) {
        ...
        $releaseNotes = Join-Path $projectRoot "release\NeuroStation-MVP1.0.2-Windows-x64.md"
        ...
        $zipPath = Join-Path $distRoot "NeuroStation-MVP1.0.2-Windows-x64.zip"
